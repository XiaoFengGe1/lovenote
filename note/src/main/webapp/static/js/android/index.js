...
$(document).on("click",".addClick",function(){
	...
	var id = $(this).attr("value");
	 ...
	 location.href="/android/note?id="+id;
});
		        ...
		        success:function(data,textStatus){
		        	...
		        	if(data.data["total"]==0){
		        	 ...
		        	 $.each(data.data["rows"],function(j, item) {
		        		    var note1='<div class="myblog lxfHeight"><h3 class="myFontTitle addClick btn" style="display:inline;" value="';
		 ...
		 $.ajax({
		        ...
		        success:function(data,textStatus){
		        	...
		        	if(data.data["total"]==0){
		        	 ...
		        	 $("#resultNum").html(data.data["total"]);
		        	 $.each(data.data["rows"],function(j, item) {
		        		    var note1='<div class="mySearch mySearchHeight"><h3 class="myFontTitle addClick" style="display:inline;" value="';
		        		    var note2='">'+item["title"]+'</h3>';
		        		    var note3='<p style="display:inline;" class="blog-post-meta myFontFooter myblogFooter">'
		        		    var note4=timeFormat(item["createtime"],'yyyy-MM-dd:HH');
		        		    var note5=' | <span class="glyphicon glyphicon-user">'+item["uname"];
		 ...
		 $.ajax({
		        ...
		        success:function(data,textStatus){
		        	...
		        	if(data.data["total"]==0){
		        	 ...
		        	 $("#resultNum").html(data.data["total"]);
		        	 $.each(data.data["rows"],function(j, item) {
		        		 var note1='<div class="mySearch mySearchHeight"><h3 class="myFontTitle addClick btn" style="display:inline;" value="';
		        		    var note2='">'+item["title"]+'</h3>';
		        		    var note3='<p style="display:inline;" class="blog-post-meta myFontFooter myblogFooter">'
		        		    var note4=timeFormat(item["createtime"],'yyyy-MM-dd:HH');
		        		    var note5=' | <span class="glyphicon glyphicon-user">'+item["uname"];
