...
public class Email {
	...
	public void toAddress(String address,String title,String content) {
		// TODO Auto-generated constructor stub
	  ...
	  public static MimeMessage createSimpleMail(Session session,String toAddress,String title,String contnt)
	            throws Exception {
	        //创建邮件对象
